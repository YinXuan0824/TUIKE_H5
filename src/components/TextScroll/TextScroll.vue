<!--
 * @Author: YinXuan
 * @Date: 2024-05-17 13:06:53
 * @LastEditTime: 2025-04-21 13:30:27
 * @Description: Vue3文字滚动 https://blog.csdn.net/Dandrose/article/details/130217089
-->
...
function onStart() {
  if (props.vertical) {
    ...
    if (textData.value.length > displayAmount.value) {
      // 超过amount条开始滚动
